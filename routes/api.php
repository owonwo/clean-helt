...
Route::group(['namespace' => 'API'], function() {
    ...
    Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['api', 'auth:admin-api']], function() {
    ...
    Route::group(['prefix' => 'doctor', 'namespace' => 'Doctor', 'middleware' => ['api', 'auth:doctor-api']], function() {
